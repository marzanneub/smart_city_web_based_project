...
?>
    ...
    <nav class="navbar">
        <div class="container-fluid justify-content-around">
            <div class="main">
                <form action="add_service_back.php" method="POST" class="form">
                    <div class="mb-3">
            ...
            <div class="main">
                <form action="update_service_back.php" method="POST" class="form">
                    <div class="mb-3">
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = mysqli_fetch_assoc($sql_query))
                            {
                                ...
                                echo "<td class='text-center'><img src='Photos/Services/" . $row['image'] . "'  width='50px'></td>";
