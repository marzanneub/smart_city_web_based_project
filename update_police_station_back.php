...
require('admin_check.php');
	...
	{
		$update_message=2;
		header("location:police_stations_admin.php?update_message=$update_message");
		exit();
	}
    ...
    if(strlen($phone_number))
	{
        for($i=0; $i<strlen($phone_number); $i++)
        {
            ...
            {
                $update_message=3;
                header("location:police_stations_admin.php?update_message=" . urlencode($update_message));
                exit();
            }
        }
